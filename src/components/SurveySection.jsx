    ...
    return (
        <Space direction="vertical" style={{ width: '100%' }} size="middle">
            <Alert
                ...
                showIcon
                message={type === 'confidence_pre' ? 'Самооценка уверенности (до обучения)' : 'Самооценка уверенности (после обучения)'}
    ...
    return (
        <div style={{ maxWidth: 780, margin: '0 auto', padding: '24px 16px' }}>
            ...
            <Paragraph type="secondary" style={{ marginBottom: 24 }}>
                В рамках НИР «Апробация цифрового тренажёра аускультации» заполните, пожалуйста, опросники.
                Данные используются только в обезличенном виде для научного анализа.
            </Paragraph>
